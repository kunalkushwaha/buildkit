...
type SolveRequest struct {
	...
	Entitlements      *pb.EntitlementList `protobuf:"bytes,6,opt,name=Entitlements" json:"Entitlements,omitempty"`
...
func (m *SolveRequest) GetEntitlements() *pb.EntitlementList {
	if m != nil {
...
func (m *SolveRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Entitlements != nil {
		dAtA[i] = 0x32
		i++
		i = encodeVarintGateway(dAtA, i, uint64(m.Entitlements.Size()))
		n7, err := m.Entitlements.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *SolveRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 6:
			...
			if m.Entitlements == nil {
				m.Entitlements = &pb.EntitlementList{}
			}
...
var fileDescriptorGateway = []byte{
	...
	,
}
