...
type SolveRequest struct {
	...
	Entilements   *pb.EntitlementList `protobuf:"bytes,9,opt,name=Entilements" json:"Entilements,omitempty"`
}
...
func (m *SolveRequest) GetEntilements() *pb.EntitlementList {
	if m != nil {
		return m.Entilements
	}
	return nil
}
...
func (m *SolveRequest) MarshalTo(dAtA []byte) (int, error) {
	...
	i += n4
	if m.Entilements != nil {
		dAtA[i] = 0x4a
		i++
		i = encodeVarintControl(dAtA, i, uint64(m.Entilements.Size()))
		n5, err := m.Entilements.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *SolveRequest) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 9:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Entilements", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if m.Entilements == nil {
				m.Entilements = &pb.EntitlementList{}
			}
			if err := m.Entilements.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
var fileDescriptorControl = []byte{
	...
	,
}
