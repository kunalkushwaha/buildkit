...
import (
	...
	"github.com/moby/buildkit/util/entitlement/apparmor"
...
func (p *OCIProfile) AddCaps(capsToAdd ...osdefs.Capability) {
...
func (p *OCIProfile) RemoveCaps(capsToRemove ...osdefs.Capability) {
...
func allowSyscallWithArgs(seccompProfile *specs.LinuxSeccomp, syscallName osdefs.Syscall, syscallArgs []specs.LinuxSeccompArg) *specs.LinuxSeccomp {
...
func (p *OCIProfile) AllowSyscallsWithArgs(syscallsWithArgsToAllow map[osdefs.Syscall][]specs.LinuxSeccompArg) {
...
func (p *OCIProfile) AllowSyscalls(syscallsToAllow ...osdefs.Syscall) {
	syscallsWithNoArgsToAllow := make(map[osdefs.Syscall][]specs.LinuxSeccompArg)
...
func (p *OCIProfile) BlockSyscallsWithArgs(syscallsWithArgsToBlock map[osdefs.Syscall][]specs.LinuxSeccompArg) {
...
func (p *OCIProfile) BlockSyscalls(syscallsToBlock ...osdefs.Syscall) {
	syscallsWithNoArgsToBlock := make(map[osdefs.Syscall][]specs.LinuxSeccompArg)
