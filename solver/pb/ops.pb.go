...
func (NetMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{0}
}

type SecMode int32

const (
	SecMode_UNCONFINED SecMode = 0
	SecMode_CONFINED   SecMode = 1
)

var SecMode_name = map[int32]string{
	0: "UNCONFINED",
	1: "CONFINED",
}
var SecMode_value = map[string]int32{
	"UNCONFINED": 0,
	"CONFINED":   1,
}

func (x SecMode) String() string {
	return proto.EnumName(SecMode_name, int32(x))
}
func (SecMode) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{1}
}
...
func (MountType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{2}
}
...
func (CacheSharingOpt) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{3}
}
...
type Op struct {
	...
	Entitlements         *EntitlementList   `protobuf:"bytes,12,opt,name=entitlements" json:"entitlements,omitempty"`
...
func (m *Op) GetEntitlements() *EntitlementList {
	if m != nil {
...
type ExecOp struct {
	...
	Security             SecMode  `protobuf:"varint,4,opt,name=security,proto3,enum=pb.SecMode" json:"security,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}
...
func (m *ExecOp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ExecOp.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *ExecOp) GetSecurity() SecMode {
	if m != nil {
		return m.Security
	}
	return SecMode_UNCONFINED
}
...
func (*Meta) Descriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{4}
}
...
func (*Mount) Descriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{5}
}
...
func (*CacheOpt) Descriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{6}
}
...
func (m *CacheOpt) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CacheOpt.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (*SecretOpt) Descriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{7}
}
...
func (m *SecretOpt) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SecretOpt.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (*CopyOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{8}
}
...
func (m *CopyOp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CopyOp.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (*CopySource) Descriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{9}
}
...
func (m *CopySource) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_CopySource.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (*SourceOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{10}
}
...
func (m *SourceOp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_SourceOp.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (*BuildOp) Descriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{11}
}
...
func (m *BuildOp) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BuildOp.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (*BuildInput) Descriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{12}
}
...
func (m *BuildInput) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_BuildInput.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (*OpMetadata) Descriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{13}
}
...
func (*ExportCache) Descriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{14}
}
...
func (m *ExportCache) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ExportCache.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (*ProxyEnv) Descriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{15}
}
...
func (m *ProxyEnv) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_ProxyEnv.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (*WorkerConstraints) Descriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{16}
}
...
func (m *WorkerConstraints) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_WorkerConstraints.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (*Definition) Descriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{17}
}
...
func (m *EntitlementList) Reset()         { *m = EntitlementList{} }
func (m *EntitlementList) String() string { return proto.CompactTextString(m) }
func (*EntitlementList) ProtoMessage()    {}
func (*EntitlementList) Descriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{18}
}
func (m *EntitlementList) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *EntitlementList) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_EntitlementList.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (dst *EntitlementList) XXX_Merge(src proto.Message) {
	xxx_messageInfo_EntitlementList.Merge(dst, src)
}
func (m *EntitlementList) XXX_Size() int {
	return m.Size()
}
func (m *EntitlementList) XXX_DiscardUnknown() {
	xxx_messageInfo_EntitlementList.DiscardUnknown(m)
}

var xxx_messageInfo_EntitlementList proto.InternalMessageInfo

func (m *EntitlementList) GetEntitlement() []*Entitlement {
	if m != nil {
...
func (*Entitlement) Descriptor() ([]byte, []int) {
	return fileDescriptor_ops_d9833363282284d8, []int{19}
}
...
func (dst *Entitlement) XXX_Merge(src proto.Message) {
	xxx_messageInfo_Entitlement.Merge(dst, src)
}
...
func (m *Entitlement) GetProfile() string {
	if m != nil {
		return m.Profile
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*EntitlementList)(nil), "pb.EntitlementList")
	proto.RegisterType((*Entitlement)(nil), "pb.Entitlement")
	proto.RegisterEnum("pb.NetMode", NetMode_name, NetMode_value)
	proto.RegisterEnum("pb.SecMode", SecMode_name, SecMode_value)
...
func (m *Op) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Entitlements != nil {
		dAtA[i] = 0x62
		i++
		i = encodeVarintOps(dAtA, i, uint64(m.Entitlements.Size()))
		n4, err := m.Entitlements.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n4
...
func (m *Op_Exec) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Exec != nil {
		...
		n5, err := m.Exec.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *Op_Copy) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Copy != nil {
		...
		n7, err := m.Copy.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n7
...
func (m *Meta) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.ProxyEnv != nil {
		...
		n10, err := m.ProxyEnv.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
...
func (m *Mount) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.CacheOpt != nil {
		...
		n11, err := m.CacheOpt.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
	...
	if m.SecretOpt != nil {
		...
		n12, err := m.SecretOpt.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
...
func (m *EntitlementList) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalTo(dAtA)
	if err != nil {
...
func (m *EntitlementList) MarshalTo(dAtA []byte) (int, error) {
	var i int
	_ = i
	var l int
	_ = l
	if len(m.Entitlement) > 0 {
		for _, msg := range m.Entitlement {
			dAtA[i] = 0xa
			i++
			i = encodeVarintOps(dAtA, i, uint64(msg.Size()))
			n, err := msg.MarshalTo(dAtA[i:])
...
func (m *Entitlement) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Profile) > 0 {
		dAtA[i] = 0xa
		i++
		i = encodeVarintOps(dAtA, i, uint64(len(m.Profile)))
...
func (m *EntitlementList) Size() (n int) {
	var l int
	_ = l
	if len(m.Entitlement) > 0 {
		for _, e := range m.Entitlement {
			l = e.Size()
			n += 1 + l + sovOps(uint64(l))
		}
	}
...
func (m *Op) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			...
			if m.Entitlements == nil {
				m.Entitlements = &EntitlementList{}
			}
			if err := m.Entitlements.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
	...
	for iNdEx < l {
		...
		case 4:
			...
			for shift := uint(0); ; shift += 7 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.Security |= (SecMode(b) & 0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *EntitlementList) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: EntitlementList: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: EntitlementList: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 2 {
			...
			m.Entitlement = append(m.Entitlement, &Entitlement{})
			if err := m.Entitlement[len(m.Entitlement)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func init() { proto.RegisterFile("ops.proto", fileDescriptor_ops_d9833363282284d8) }

var fileDescriptor_ops_d9833363282284d8 = []byte{
	...
	,
}
